...
void f(double t, double *rop, double *x, double *p) {
  ...
  cinf = 1/(1+exp(-2*(0.4)*(x[0]-(-27.0))));

  taum = cosh ((0.1) * (x[0] - (2.0))/2.0);
  tauc = cosh ((0.4) * (x[0] - (-27.0))/2.0);
  ...
  cinf = 1/(1+exp(-2*(0.4)*(x[3]-(-27.0))));

  taum = cosh ((0.1) * (x[3] - (2.0))/2.0);
  tauc = cosh ((0.4) * (x[3] - (-27.0))/2.0);
  ...
  cinf = 1/(1+exp(-2*(0.4)*(x[6]-(-27.0))));

  taum = cosh ((0.1) * (x[6] - (2.0))/2.0);
  tauc = cosh ((0.4) * (x[6] - (-27.0))/2.0);
  ...
  // Sinapsis 0->1
  aux[3] += -(0.015) * x[9] * (x[3] - (-70.0)) / (1.2);
  // Sinapsis 2->1
  aux[3] += -(0.015) * x[11] * (x[3] - (-70.0)) / (1.2);
