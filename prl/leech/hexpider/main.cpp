...
const int M = 5; // Number of points per dimension
const double vshift = -0.002; // VERTICAL
const double Iext = 0.0; // HORIZONTAL
...
void work(double phi21, double phi31, deque<pair<int, double> > &result) {
  ...
  double pars[3] = {vshift, Iext, 0.0};
  double poincareThresHold = -1.2;
  rk(nvar, y, 0.0, 100, 100,
        pars, 1.0e-8, 0, poincareThresHold);

  double P = rk(nvar, y, 0.0, 2000, 2000,
